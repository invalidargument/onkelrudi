    ...
    protected function runQuery()
    {
        ...
        $affected4 = $this->pdo
            ->exec(
                ...
                "INSERT INTO fleamarkets_users (email, password, type, opt_in) VALUES ('test2@onkel-rudi.de', '$2y$10$5OMCRF2m6KDcKLF1qV20Det5DzDAwga9An3hK84OeVMi/WjYDwkOy', 'organizer', 1); ".
                "INSERT INTO fleamarkets_users (email, password, type, opt_in) VALUES ('admin@onkel-rudi.de', '$2y$10$5OMCRF2m6KDcKLF1qV20Det5DzDAwga9An3hK84OeVMi/WjYDwkOy', 'admin', 1); ".
